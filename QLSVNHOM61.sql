...
AS
BEGIN
DECLARE @IDSV CHAR(10);
SET @IDSV=CAST(NEXT VALUE FOR SE_MASV AS CHAR(10));
DECLARE @IDTK CHAR(10);
SET @IDTK='TK'+@IDSV;
INSERT INTO TAIKHOAN VALUES(@IDTK,'SV'+@IDSV,'123','sv',NULL);
INSERT INTO SINHVIEN VALUES('SV'+@IDSV,@AnhDaiDien,@CMND,@TenSV,@NgaySinh,@GioiTinh,@DanToc,@TonGiao,@DiaChi,@QueQuan,@SDT,@NgayNhapHoc,@MaLop,@IDTK,@GhiChu);
END
GO 
...
BEGIN
DECLARE @IDTK CHAR(10);
SET @IDTK = (SELECT MaTk FROM SINHVIEN WHERE MaSV=@MaSV);
...
INSERT INTO KHOAHOC VALUES('K1000',N'Cao Đẳng','2023-01-01','2023-01-01','CT100',NULL);
