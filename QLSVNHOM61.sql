...
SET @IDTK='TK'+@MaSV;
INSERT INTO TAIKHOAN VALUES(@IDTK,@MaSV,'123','sv',NULL);
INSERT INTO SINHVIEN VALUES(@MaSV,@AnhDaiDien,@CMND,@TenSV,@NgaySinh,@GioiTinh,@DanToc,@TonGiao,@DiaChi,@QueQuan,@SDT,@NgayNhapHoc,@MaLop,@IDTK,@GhiChu);
END
GO 
